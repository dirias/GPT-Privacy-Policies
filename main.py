...
# 5. Prediction
print('Prediction ------------------------------------->')
new_document = ["The weather is wonderful today.", "I love sunny days.", "It makes me feel so energetic."]
new_encodings = tokenizer(new_document, truncation=True, padding='max_length', max_length=MAX_LENGTH, return_tensors="tf")
